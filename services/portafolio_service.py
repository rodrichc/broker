...
class PortafolioService:
    ...
    def listar_activos(self, id_inversor):
        ...
        activos = self.portafolio_dao.obtener_activos_portafolio(portafolio.id_portafolio)
        resultados = []

        for activo in activos:
            # accion = self.accion_dao.obtener_accion(activo['simbolo'])
            # if accion:
    ...
    def obtener_datos_cuenta(self, id_inversor):
        ...
        total_invertido = portafolio.total_invertido
